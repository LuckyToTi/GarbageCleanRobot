...
enum minmea_sentence_id {
    ...
    MINMEA_SENTENCE_VTG,
    MINMEA_SENTENCE_ZDA,
    MINMEA_SENTENCE_DVEXT,
    MINMEA_SENTENCE_DVPDL,
};
...
struct minmea_sentence_dvext {
    char v, g, la, lb, lc, ld;
    int abcd;
    struct minmea_float r, p, h, k, u, t, n, e, lat, long_e, eee;
    struct minmea_float qw, qx, qy, qz, va, vb, vc, vd, ra, rb, rc, rd;
    int ga, gb, gc, gd;
};

struct minmea_sentence_dvpdl {
    struct minmea_time tu, dtu;
    int c;
    struct minmea_float adr, adp, ady, pdx, pdy, pdz;
};
