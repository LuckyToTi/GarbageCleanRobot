...
#include "config.h"
#define RT_LWIP_IPADDR  (get_config()->net_config.ip_addr)
#define RT_LWIP_GWADDR  (get_config()->net_config.gw_addr)
#define RT_LWIP_MSKADDR (get_config()->net_config.msk_addr)
...
#define RT_LWIP_TCP_SND_BUF 4098
...
#define MODBUS_MASTER_RT_CONTROL_PIN_INDEX 64
